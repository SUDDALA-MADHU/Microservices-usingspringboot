...
import eshop.home.security.JWT.JwtEntryPoint;
import eshop.home.security.JWT.JwtFilter;
...
//                .antMatchers("/api/delete/customer/{email}").permitAll()
